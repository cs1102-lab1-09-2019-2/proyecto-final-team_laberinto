...
private:
    ...
    TipoEntero Columnas;
public:
    Mapa(const TipoCaracter *_Plantilla, TipoEntero _Filas, TipoEntero _Columnas) : Plantilla(_Plantilla), Filas(_Filas), Columnas(_Columnas){}
    ~Mapa(){}
    TipoEntero **LeerArchivo(){
        TipoEntero limite = (Fila * Fila) - 1;
